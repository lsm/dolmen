...
func (c *config) validate() error {
	...
	if c.meterProviderSet && nilProvider(c.meterProvider) {
		return derr.New(derr.InvalidRequest, "WithMeterProvider: provider must not be nil; omit the option to leave metrics off")
	}

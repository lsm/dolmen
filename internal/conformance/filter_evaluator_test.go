...
var pinnedFilterSemantics = []struct {
	...
	{"a chosen comparison equals a bound number", "iif(id = 1, n > 1, NULL) = ?", `[0]`},
	{"a chosen comparison never equals a bound text", "NOT (iif(id = 1, n > 1, NULL) = ?)", `["0"]`},
	{"a chosen comparison is a truth value", "iif(id = 1, n < 1, NULL)", ""},

...
evaluator across engines. The disclosure has a **pinned name**, or it is not portable: the capability
...
construction under §4.3's shared allowlist, on every engine. Adapter #1 reports `"sqlite"`. The value is an open enum — a new engine
